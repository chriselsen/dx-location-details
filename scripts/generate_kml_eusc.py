...
def generate_kml(locations, output_file):
    """Generate KML file for EUSC locations"""
    kml = f"""<?xml version="1.0" encoding="UTF-8"?>
<kml xmlns="http://www.opengis.net/kml/2.2">
  <Document>
    <name>AWS Direct Connect Locations - EU Sovereign Cloud</name>
    <description>EU Sovereign Cloud Direct Connect Locations</description>
...
def main():
    ...
    # Generate EUSC KML
    count = generate_kml(locations, 'output/DirectConnectLocations_EUSC.kml')
    print(f"Generated: output/DirectConnectLocations_EUSC.kml ({count} locations)")
